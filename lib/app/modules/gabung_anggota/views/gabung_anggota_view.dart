...
class GabungAnggotaView extends GetView<GabungAnggotaController> {
  const GabungAnggotaView({super.key});
                    ...
                    const Expanded(
                      child: Column(
                        ...
                        children: [
                          ...
                          SizedBox(height: 4),
                          Text(
                            "Pindai barcode undangan untuk bergabung ke anggota.",
                            style: TextStyle(
