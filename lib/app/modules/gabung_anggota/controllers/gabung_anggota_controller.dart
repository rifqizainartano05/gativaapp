...
class GabungAnggotaController extends GetxController {
  ...
  void validateAccessCode() async {
    ...
    if (accessCode.isEmpty) {
      _showErrorDialog("Kode akses tidak boleh kosong.");
      return;
    }
    ...
    try {
      ...
      // Menggunakan logika yang sama dengan processScannedData
      _processScannedData("GATIVA_INVITE:$ownerUid:$token");
    } catch (e) {
      Get.back();
      _showErrorDialog("Terjadi kesalahan atau Index Firebase belum dibuat. Silakan hubungi admin.");
      debugPrint("Error validateAccessCode: $e");
    }
  }
  ...
  Future<void> _joinGroup(String ownerUid, String token) async {
    ...
    if (currentUser == null) {
      _showErrorDialog("Anda harus masuk untuk bergabung.");
      return;
    }
    ...
    try {
      ...
      _showErrorDialog("Gagal mengirim permintaan bergabung.");
    }
  }
