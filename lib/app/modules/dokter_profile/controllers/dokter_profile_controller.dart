...
class DokterProfileController extends GetxController with WidgetsBindingObserver {
  ...
  void fetchProfileData() {
    try {
      ...
      if (user != null) {
        dokterUid.value = user.uid;
        dokterEmail.value = user.email ?? 'email@domain.com';
  ...
  void _listenToIncomingChats() async {
    ...
    try {
      ...
      print("Error listening to dokter chats: $e");
    }
  }
  ...
  void showBarcodeDialog() {
    if (dokterUid.value.isEmpty) return;
