...
class RiwayatAnggotaView extends StatelessWidget {
  const RiwayatAnggotaView({super.key});

  @override
  Widget build(BuildContext context) {
    final RiwayatAnggotaController controller = Get.put(RiwayatAnggotaController());
