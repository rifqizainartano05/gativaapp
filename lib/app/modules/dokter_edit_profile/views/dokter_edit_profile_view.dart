...
class DokterEditProfileView extends GetView<DokterEditProfileController> {
  const DokterEditProfileView({super.key});
              ...
              _buildCard(
                child: Column(
                  children: [
                    ...
                    const Divider(height: 1, color: Color(0xFFEEEEEE)),
                    _buildTextField(
                      controller: controller.praktikDimanaController,
                      label: 'Praktik Dimana (Misal: RSUD Kota, Klinik Sehat)',
