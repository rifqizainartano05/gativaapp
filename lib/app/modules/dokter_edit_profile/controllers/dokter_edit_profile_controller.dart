...
class DokterEditProfileController extends GetxController {
  ...
  final praktikDimanaController = TextEditingController();
  ...
  void loadUserData() async {
    ...
    if (user != null) {
      ...
      if (doc.exists) {
        ...
        praktikDimanaController.text = data['praktik_dimana'] ?? data['jadwal_online'] ?? '';
      }
    }
    ...
    try {
      ...
      if (user != null) {
        await Get.find<AuthService>().getUserReference(user.uid).update({
          ...
          'praktik_dimana': praktikDimanaController.text.trim(),
        });
